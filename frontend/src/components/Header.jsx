        ...
        <header className="flex h-20 items-center justify-between border-b border-border-color bg-bg-secondary px-8">
            ...
            <div className="flex items-center gap-6">
                ...
                <div className="relative w-full max-w-xs hidden lg:block">
                    ...
                    <input type="text" placeholder="Search..." className="form-input block w-full rounded-md border-0 bg-bg-primary py-2 pl-10 pr-3 text-white ring-1 ring-inset ring-border-color placeholder:text-text-secondary focus:ring-2 focus:ring-inset focus:ring-accent-primary sm:text-sm" />
                </div>
                ...
                <div className="relative">
                    <button 
                        ...
                        className="h-10 w-10 rounded-full bg-cover bg-center focus:outline-none focus:ring-2 focus:ring-accent-primary focus:ring-offset-2 focus:ring-offset-bg-secondary" 
                        style={{ backgroundImage: `url("https://images.unsplash.com/photo-1535713875002-d1d0cf377fDE?q=80&w=2080&auto=format&fit=crop")` }}
                    ></button>
                    {isMenuOpen && (
                        <div className="absolute right-0 mt-2 w-48 bg-bg-tertiary rounded-lg shadow-lg py-1 z-10">
                            <button
                                onClick={handleLogout}
                                className="flex items-center gap-3 w-full px-4 py-2 text-sm text-text-primary hover:bg-accent-primary transition-colors"
                            >
