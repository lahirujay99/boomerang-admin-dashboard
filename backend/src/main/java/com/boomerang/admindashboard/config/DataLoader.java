...
public class DataLoader implements CommandLineRunner {
    ...
    private void loadData() {
        ...
        Customer cust1 = new Customer(null, "Liam Harper", "liam.harper@email.com", LocalDate.of(2022, 1, 15), new BigDecimal("500.00"));
        Customer cust2 = new Customer(null, "Olivia Bennett", "olivia.bennett@email.com", LocalDate.of(2022, 2, 20), new BigDecimal("750.00"));
        Customer cust3 = new Customer(null, "Noah Carter", "noah.carter@email.com", LocalDate.of(2022, 3, 10), new BigDecimal("300.00"));
        Customer cust4 = new Customer(null, "Ava Mitchell", "ava.mitchell@email.com", LocalDate.of(2024, 6, 5), new BigDecimal("1200.00"));
        Customer cust5 = new Customer(null, "Ethan Parker", "ethan.parker@email.com", LocalDate.of(2024, 7, 1), new BigDecimal("900.00"));
        ...
        Sale sale3 = new Sale(null, customers.get(2), LocalDate.of(2024, 1, 17), new BigDecimal("75.50"), SaleStatus.CANCELLED);
        Sale sale4 = new Sale(null, customers.get(3), LocalDate.of(2024, 6, 18), new BigDecimal("300.00"), SaleStatus.COMPLETED);
        Sale sale5 = new Sale(null, customers.get(4), LocalDate.of(2024, 7, 2), new BigDecimal("120.25"), SaleStatus.PENDING);
        Sale sale6 = new Sale(null, customers.get(0), LocalDate.of(2024, 5, 19), new BigDecimal("180.75"), SaleStatus.COMPLETED);
